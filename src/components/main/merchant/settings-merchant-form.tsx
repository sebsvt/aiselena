...
interface EditMerchantSettingsProps {
  merchantData: MerchantData;
}

export const EditMerchantSettings: React.FC<EditMerchantSettingsProps> = ({
  merchantData,
}) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      domain: merchantData.domain.replace(".aiselena.com", ""),
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    console.log({
      ...values,
      domain: `${values.domain}.aiselena.com`,
    });
    toast({
      title: "Merchant settings updated",
      description: "The merchant settings have been successfully updated.",
    });
  }

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Edit Merchant Settings</h1>
      <Form {...form}>
